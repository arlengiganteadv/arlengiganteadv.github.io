          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                oferecemos soluções jurídicas personalizadas que protegem seus interesses e recuperam sua saúde financeira.
              </p>
              <p className="text-base text-primary font-semibold bg-primary/10 p-4 rounded-lg">
                🌟 Especialidade: Prorrogação de dívidas rurais com até <strong>3+ anos de carência</strong> e <strong>até 20 anos para pagar</strong>.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <Card className="p-4 border-border hover:border-primary/50 transition-colors">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                  <h3 className="font-semibold text-foreground">Especializações Jurídicas</h3>
                  <p className="text-sm text-muted-foreground">Direito Bancário Rural, Prorrogação com Carência, Crédito Rural e Defesa dos Produtores</p>
                  </div>
                </div>
              </Card>
